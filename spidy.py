...
bot = telebot.TeleBot('8020271957:AAGt5kvKMVYZpKKdDEPWzMnxQ8qMZPQXZiM')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 300:
                response = "𝐵𝑅𝑂 𝐼𝑇𝑆 𝑂𝑉𝐸𝑅 𝐹𝑂𝑅 𝐴𝑇𝑇𝐴𝐶𝐾 𝑇𝑂 𝐷𝑂 𝐿𝐸𝑆𝑆 𝑇𝐻𝐸𝑁 3𝟎𝟎 𝑆𝐸𝐶𝑂𝑁𝐷𝑆."
            else:
...
🚀 𝐴𝐶𝐶𝐸𝑆𝑆 𝐻𝐸𝑅𝐸 :- @RAJPUTDDOS
🚀 𝐽𝑂𝐼𝑁 𝐹𝐴𝑀𝐼𝐿𝐼𝑌:- @RAJPUTDDOS
'''
...
def welcome_start(message):
    ...
    response = f'''𝑊𝐸𝐿𝐶𝑂𝑀𝐸 𝑇𝑂 𝐷𝐷𝑂𝑆 𝑆𝐸𝑅𝑉𝐸𝑅 𝑇𝐻𝐼𝑆 𝐹𝐼𝐿𝐸 𝑃𝑅𝑂𝑉𝐼𝐷𝐸 𝐵𝑌 @RAJPUTDDOS
 𝑁𝐸𝐸𝐷 𝑃𝑅𝑂𝑂𝐹 𝐴𝑁𝐷 𝐷𝐷𝑂𝑆 𝐹𝐼𝐿𝐸 𝐽𝑂𝐼𝑁 𝐻𝐸𝑅𝐸
 𝐽𝑂𝐼𝑁 𝑇𝑂 𝐹𝐴𝑀𝐼𝐿𝐼𝑌 :- @RAJPUTDDOS'''
    bot.reply_to(message, response)
...
𝐵𝐺𝑀𝐼 𝐷𝐷𝑂𝑆 𝑃𝐿𝐴𝑁 𝑁𝐸𝐸𝐷 𝐹𝑅𝐸𝐸 𝑇𝑂 𝐽𝑂𝐼𝑁 @RAJPUTDDOS 𝐹𝑂𝑅 𝐹𝑅𝐸𝐸 𝐵𝑂𝑇𝑆 𝐴𝑁𝐷 𝐹𝐼𝐿𝐸 
'''
    bot.reply_to(message, response)
